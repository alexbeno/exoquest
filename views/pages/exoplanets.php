...
<form method="post">
	<div class="group">
		...
		<input type="number" name="disc-year">
	</div>
	<div class="group">
		<label for="up-temp">Temperature upper: </label>
		<input type="number" name="up-temp">K
	</div>
	<div class="group">
		<label for="bel-temp">Temperature below: </label>
		<input type="number" name="bel-temp">K
	</div>
	<div class="group">
	...
	<div class="group">
		...
		<input type="number" name="up-mass">M☉
	</div>
	<div class="group">
		<label for="bel-mass">Mass below: </label>
		<input type="number" name="bel-mass">K
	</div>
	<div class="group">
